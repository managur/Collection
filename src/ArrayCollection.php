...
/**
 * Managur Generic ArrayCollection Class
 ...
 * @license MIT
 */
class ArrayCollection extends ArrayObject implements Collection
{
    ...
    public static function newCollectionOfType(string $type, $items = []): Collection
    {
        ...
        if (is_subclass_of($type, Collection::class) === false) {
    ...
    /**
     * Map Function Against Collection and Return New ArrayCollection
     *
    ...
    /**
     * Walk Over ArrayCollection Entities
     *
    ...
    /**
     * Reduce ArrayCollection by Callable
     *
    ...
    /**
     * Filter ArrayCollection By Callable
     *
     * @param callable|null $callable Callback for each iteration. If null will just filter empty values from array
     * @param int|null $flag ArrayCollection::FILTER_USE_KEY or ArrayCollection::FILTER_USE_BOTH
     * @return static
     */
    // phpcs:ignore Squiz.WhiteSpace.ScopeKeywordSpacing.Incorrect -- Broken until 3.6.0
    ...
    /**
     * Get First Entry From ArrayCollection
     *
    ...
    /**
     * Get Last Entry From ArrayCollection
     *
    ...
    /**
     * Check if ArrayCollection Contains Value
     *
    ...
    /**
     * Pop Entity Off Of The End Of The ArrayCollection
     *
     * @return mixed
     */
    ...
    /**
     * Push Entities On To The End Of The ArrayCollection
     *
     * @param array ...$vals
     */
    ...
    /**
     * Get a New ArrayCollection With Another ArrayCollection Merged In
     *
    ...
    /**
     * Get a New ArrayCollection With Contents Sorted
     *
    ...
    /**
     * Get a New ArrayCollection With Contents Sorted By User Defined Callable
     *
    ...
    /**
     * Get a New ArrayCollection With Contents Sorted, Maintaining Index Associations
     *
     * @param int $flags
     * @return static
     */
    ...
    /**
     * Get a New ArrayCollection With Contents Shuffled
     *
     * @param $seed int|null
     * @return static
     */
    ...
    private static function getTypedCollection(
        ...
        return new class ($data, $keyType, $valueType) extends ArrayCollection {
    ...
    /**
     * Get a New Anonymous Typed Value ArrayCollection
     *
    ...
    /**
     * Get a New Anonymous Typed Key ArrayCollection
     *
    ...
    /**
     * Get a New Anonymous Typed ArrayCollection
     *
     * @param ?string $keyType The type that all keys must match
     * @param ?string $valueType The type that all values must match
     * @param mixed $data
    ...
    /**
     * Get a JSON Serializable Representation of this ArrayCollection
     */
